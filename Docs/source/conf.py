...
sys.path.insert(0, os.path.abspath('../../mkla'))


# -- Project information -----------------------------------------------------

project = 'convertToArXiv'
copyright = '2021 Justin Pierel'
...
#     'doc_module': ('convertToArXiv',),  # documented module(s)
...
#html_favicon = '_static/your_image_here.png'
...
htmlhelp_basename = 'convertToArXiv'+'doc'
...
latex_documents = [
    (master_doc, 'convertToArXiv'+'.tex', 'convertToArXiv'+' Documentation',
...
man_pages = [
    (master_doc, 'convertToArXiv', 'convertToArXiv'+' Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'convertToArXiv', 'convertToArXiv'+' Documentation',
     author, 'convertToArXiv', 'One line description of project.',
     'Miscellaneous'),
]
